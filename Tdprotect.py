...
cl = LINETCR.LINE()
cl.login(token="ErYVvpMJWPDczWPPSMM0.9q2iIcfJltjghJCvoSD1Wa.Da03u0viyVrRQFYTKDYCjUIkJMb+5vQ6xJd6ed7JOUY=")
cl.loginResult()

ki = LINETCR.LINE()
ki.login(token="ErhsjkUqHA35GHBbXH5d.HGgncuHcDdzckuAbv/uk3q.TUpsVPZaKwiJKp5AMk7TKvdOGM2ljrQVs7yWG/vYIJA=")
ki.loginResult()

kk = LINETCR.LINE()
kk.login(token="ErNPZNdkogLBhpMJsRa9.I5rdSKP0GBT4JKWfwneB2q.qCgQ+pKZQnRSt9567I+nE3M2dwYpkE5pHj42mvFCBZQ=")
kk.loginResult()

kc = LINETCR.LINE()
kc.login(token="ErMAX2HGWHk8iKbt78J8.qwgL7DJ1+YEOyOYnOpSjsa.py/8HvX3LPZKdec4j/b7GlMhmrZDfXCDslBHzaU7IY0=")
kc.loginResult()

kb = LINETCR.LINE()
kb.login(token="ErGi0Z3qALsFdnHNqpad.bZf8ov6OfVotpzQwqiHbBq.Tko5jm2/zWMVoec6d2L73gqV3c+Ek3pEOygLvCvFyVw=")
kb.loginResult()

kd = LINETCR.LINE()
kd.login(token="ErrJEgDOAAepcSss0VZd.+YROKxqbv6sVDLo3fqJLhq.yf6qmtqIxJFfk2v+jnYoZU/qyxX5ylAh0P/EZA3/Qmc=")
kd.loginResult()

ke = LINETCR.LINE()
ke.login(token="ErPU6rlWxecZpRkYQ2M3.50V5Wy5D4Aee6Q86yIM3qW.GphB6G1dqryXSu/WDzBs7aI0FBHN3ZQFfAIJYJQR+PE=")
ke.loginResult()

kg = LINETCR.LINE()
kg.login(token="ErNfPc3zXu2JQLObwMKa.+t0JR6Nj/4qZGGL1auL0IG.3YoXJ/HmhGII7C+HvQvrRuKxFGsNIEmgkllHHIRRk1s=")
kg.loginResult()

kh = LINETCR.LINE()
kh.login(token="ErUbP75iykdFwSe28jm3.4I9r3MjEqk+br2FjhlzvaW.Y5Ysrw5tceMfdcHTFDUlH6GG9lCrdjHmFZXWtVAp2Lw=")
kh.loginResult()

sw = LINETCR.LINE()
sw.login(token="ErxeTwZdaROwUntsMOCb.ItDjsL+frxwoprqw2rlDoW.OWwlMDjaHUSDEbs/5iEV4tCNMrOC5R3lKKsXs3qh3pc=")
sw.loginResult()
...
wait ={ 
    ...
    'timeline':False,
    'autoAdd':False,
    'message':"Thanks for add Created by Gerhana",
    "lang":"JP",
...
#----------------Welcome---------------------------------------------
        if op.type == 15:
          if wait["goodbye"] == True:
            cl.sendText(op.param1, "Yaahh baper 😢")
...
#---------------------------------------------------------------------------------------------
		...
		if wait["Protectgroupname"] == False:
			...
			cl.sendText(msg.to,"Gnamelock already off")
#---------------------------------------------------------------------------------------------
	    elif msg.text in ["Apt on","Sw on","Sw:on"]:
	      if msg.from_ in admin:
                ...
                if wait["cancelprotect"] == True:
                    ...
                    if wait["lang"] == "JP":
                        ...
                        cl.sendText(msg.to,"CancelProtect already On")
#-----------------------------------------------------------------------------------------
            elif msg.text in ["Apt off","Sw off","Sw:off"]:
              if msg.from_ in admin:
